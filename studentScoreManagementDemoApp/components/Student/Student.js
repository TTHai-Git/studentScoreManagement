...
const Student = () => {
    ...
    const tableData = [
        ['1', 'DEDU0103', 'Giáo dục quốc phòng và an ninh: Quân sự chung', '4 10 10', '5 10 10'],
        ['1', 'DEDU0103', 'Giáo dục quốc phòng và an ninh: Quân sự chung', '4 10 10', '5 10 10'],
        ['1', 'DEDU0103', 'Giáo dục quốc phòng và an ninh: Quân sự chung', '4 10 10', '5 10 10']
    ];
            ...
            <ScrollView>
                ...
                <ScrollView horizontal={true}>
                    <View style={Styles.table}>
                        <Text style={Styles.semesterText} variant="headlineSmall">Học kỳ ...</Text>
                        <Table borderStyle={{ borderWidth: 1, borderColor: '#000' }}>
                            <Row data={tableHead} style={Styles.head} textStyle={{...Styles.text, fontWeight: 'bold'}} widthArr={widthArr}/>
                            <Rows data={tableData} style={Styles.body} textStyle={Styles.text}  widthArr={widthArr}/>
                        </Table>
                    </View>
                </ScrollView>
